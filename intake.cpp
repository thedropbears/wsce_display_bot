...
Intake::Intake(Servo &motor)
    : motor_speed_pulse_(MOTOR_PULSE_STOP_),
      upper_limit_switch_(PITCHER_UPPER_LIMIT_PIN),
...
void Intake::spin() { motor_speed_pulse_ = MOTOR_PULSE_FORWARD_; }

void Intake::stop() { motor_speed_pulse_ = MOTOR_PULSE_STOP_; }
