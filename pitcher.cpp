...
void Pitcher::raise()
{
    motor_speed_pulse_ = MOTOR_PULSE_BACKWARD_;
}
...
bool Pitcher::at_lower_limit()
{
    return digitalRead(lower_limit_switch_);
}

bool Pitcher::at_upper_limit()
{
    return digitalRead(upper_limit_switch_);
}
