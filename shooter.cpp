...
Shooter::Shooter(Servo &flywheel_motor)
...
void Shooter::load() { flywheel_motor_speed_ = MOTOR_PULSE_BACKWARD_; }

void Shooter::shoot() { flywheel_motor_speed_ = MOTOR_PULSE_FORWARD_; }

void Shooter::stop() { flywheel_motor_speed_ = MOTOR_PULSE_STOP_; }
